...
interface CardLocalDataSource {
    ...
    suspend fun completeCard(cardId: Int, spentMillis: Long): DFResult<Int, DataError>
    ...
    fun getDailyStatsForCard(cardId: Int, fromDay: Long, toDay: Long) : Flow<DFResult<List<DailyStatsDomain>, DataError>>
 }
