...
sealed interface DataError : DFError {
    ...
    sealed interface Network : DataError {
        ...
        data class Unknown(val throwable: Throwable? = null) : Network
    }
    ...
    sealed interface Local : DataError {
        ...
        data class Unknown(val throwable: Throwable? = null) : Local
    }

    sealed interface Preferences : DataError {
        data object Storage : Preferences
        data class Unknown(val throwable: Throwable? = null) : Preferences
    }
}