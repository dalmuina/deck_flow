...
class RoomCardDatasourceTest {
    ...
    @Test
    fun `saveCard returns Success with inserted id on happy path`() =
        runTest {
    ...
    @Test
    fun `saveCard returns ConstraintViolation when dao throws SQLiteConstraintException`() =
        runTest {
            val card = CardDomainTestData.card(id = 0)
    ...
    @Test
    fun `saveCard returns Unknown error when dao throws RuntimeException`() =
        runTest {
            val card = CardDomainTestData.card(id = 0)
    ...
    @Test
    fun `updateCard returns Success with card id on happy path`() =
        runTest {
    ...
    @Test
    fun `updateCard returns Unknown error when dao throws`() =
        runTest {
            val card = CardDomainTestData.card(id = 3)
    ...
    @Test
    fun `completeCard returns Success with cardId on happy path`() =
        runTest {
    ...
    @Test
    fun `completeCard returns Unknown error when insertProgress throws`() =
        runTest {
    ...
    @Test
    fun `postponeCard returns Success with cardId on happy path`() =
        runTest {
            coJustRun { dao.insertProgress(any()) }
    ...
    @Test
    fun `postponeCard returns Unknown error when insertProgress throws`() =
        runTest {
            coEvery { dao.insertProgress(any()) } throws RuntimeException("DB error")
    ...
    @Test
    fun `getAllCards emits Success with mapped domains on happy path`() =
        runTest {
    ...
    @Test
    fun `getAllCards emits Success with empty list when no cards exist`() =
        runTest {
    ...
    @Test
    fun `getAllCards emits Unknown error when flow throws`() =
        runTest {
    ...
    @Test
    fun `getCardById returns Success with mapped domain on happy path`() =
        runTest {
            val entity = CardEntity(id = 1, name = "Card 1", duration = 15000L)
    ...
    @Test
    fun `getCardById returns Unknown error when dao throws`() =
        runTest {
    ...
    @Test
    fun `deleteCard returns Success on happy path`() =
        runTest {
    ...
    @Test
    fun `deleteCard returns Unknown error when dao throws`() =
        runTest {
    ...
    @Test
    fun `getDailyStatsForCard emits Success with mapped stats on happy path`() =
        runTest {
    ...
    @Test
    fun `getDailyStatsForCard emits Success with empty list when no stats`() =
        runTest {
    ...
    @Test
    fun `getDailyStatsForCard emits Unknown error when flow throws`() =
        runTest {
