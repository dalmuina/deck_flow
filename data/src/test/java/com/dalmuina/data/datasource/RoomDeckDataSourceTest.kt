...
class RoomDeckDataSourceTest {
    ...
    @Test
    fun `createDeck returns Success with new deck id on happy path`() =
        runTest {
    ...
    @Test
    fun `createDeck returns ConstraintViolation when dao throws SQLiteConstraintException`() =
        runTest {
    ...
    @Test
    fun `createDeck returns Unknown error when dao throws RuntimeException`() =
        runTest {
    ...
    @Test
    fun `updateDeckName returns Success on happy path`() =
        runTest {
    ...
    @Test
    fun `updateDeckName returns Unknown error when dao throws`() =
        runTest {
    ...
    @Test
    fun `getAllDecksWithCards emits Success with mapped domains on happy path`() =
        runTest {
    ...
    @Test
    fun `getAllDecksWithCards emits Success with empty list when no decks exist`() =
        runTest {
    ...
    @Test
    fun `getAllDecksWithCards emits Unknown error when flow throws`() =
        runTest {
    ...
    @Test
    fun `getDeckWithCardsById emits Success with mapped deck on happy path`() =
        runTest {
    ...
    @Test
    fun `getDeckWithCardsById emits Unknown error when getDeckById flow throws`() =
        runTest {
    ...
    @Test
    fun `deleteDeck returns Success on happy path`() =
        runTest {
    ...
    @Test
    fun `deleteDeck returns Unknown error when dao throws`() =
        runTest {
    ...
    @Test
    fun `setDeckCards returns Success on happy path`() =
        runTest {
    ...
    @Test
    fun `setDeckCards returns Unknown error when dao throws`() =
        runTest {
